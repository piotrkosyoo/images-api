...
var uri="http://ec2-34-241-76-172.eu-west-1.compute.amazonaws.com/api/mandelbrot?";function getImage(params,callback){fetch(uri+params,{method:'GET'}).then(function(response){response.text().then(function(text){callback({imageBase64:"data:image/png;base64,"+text});});}).catch(function(e){return console.log(e);});}
...
//# sourceMappingURL=main.63948eb5.chunk.js.map